...
using Soenneker.Lemlist.OpenApiClient.User.EmailAccounts.Item.Test;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Lemlist.OpenApiClient.User.EmailAccounts.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \user\email-accounts\{emailAccountId}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithEmailAccountItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>The test property</summary>
        public global::Soenneker.Lemlist.OpenApiClient.User.EmailAccounts.Item.Test.TestRequestBuilder Test
        {
            get => new global::Soenneker.Lemlist.OpenApiClient.User.EmailAccounts.Item.Test.TestRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Lemlist.OpenApiClient.User.EmailAccounts.Item.WithEmailAccountItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithEmailAccountItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/user/email-accounts/{emailAccountId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Lemlist.OpenApiClient.User.EmailAccounts.Item.WithEmailAccountItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithEmailAccountItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/user/email-accounts/{emailAccountId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Lemlist.OpenApiClient.User.EmailAccounts.Item.WithEmailAccountItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Lemlist.OpenApiClient.User.EmailAccounts.Item.WithEmailAccountItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
