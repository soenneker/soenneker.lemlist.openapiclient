...
using System;
namespace Soenneker.Lemlist.OpenApiClient.Campaigns.Item.Steps.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \campaigns\{campaignId}\steps\{stepId}
    /// </summary>
    ...
    public partial class WithStepItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithStepItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/campaigns/{campaignId}/steps/{stepId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Lemlist.OpenApiClient.Campaigns.Item.Steps.Item.WithStepItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithStepItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/campaigns/{campaignId}/steps/{stepId}", rawUrl)
        {
        }
    }
}
